...
class TestAsyncRolloutResource:
    ...
    async def test_connect_returns_streaming_response(self, async_client):
        ...
        with patch.object(
            async_client.rollout._client, "stream"
    ...
    async def test_update_span_info_success(self, async_client):
        ...
        with patch.object(
            ...
            call_args = mock_patch.call_args
            assert call_args[0][0] == f"http://test-api.com:443/v1/rollouts/{session_id}/update"
            ...
            assert payload["trace_id"] == str(span_data["trace_id"])
