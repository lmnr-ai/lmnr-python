...
class LaminarClient:
    ...
    def get_datapoints(
        ...
        """Get datapoints from a dataset for use in evaluations.

        Args:
            dataset_name (str): name of the dataset
            offset (int): offset of the datapoints to get
            limit (int): maximum number of datapoints to get

        Raises:
            ValueError: if an error happens while fetching the datapoints

        Returns:
            GetDatapointsResponse: response from the datapoint retrieval
        """
