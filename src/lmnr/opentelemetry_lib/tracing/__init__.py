    ...
    def __new__(
        ...
        with cls._lock:
            if not hasattr(cls, "instance"):
                ...
                # Setup LoggerProvider for OTel logs (used by Daytona and others)
                ...
                obj._event_logger_provider = EventLoggerProvider(obj._logger_provider)
                ...
                init_instrumentations(
                    ...
                    event_logger_provider=obj._event_logger_provider,
