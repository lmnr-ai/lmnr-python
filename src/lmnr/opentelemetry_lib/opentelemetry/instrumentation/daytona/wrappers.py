...
from opentelemetry.trace import get_tracer, SpanKind, Status, StatusCode, Span
...
def _wrap(
    ...
    # Capture context with span BEFORE ending the span, so logs can be associated with it
