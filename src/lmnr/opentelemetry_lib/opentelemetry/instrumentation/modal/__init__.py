...
Modal uses a synchronicity pattern where _Sandbox is the internal async class
and Sandbox is the public API with sync/async support. We instrument both
_Sandbox (for async callers) and Sandbox (for sync callers via wrapt).
"""
